        ...
        return (
            <div className={Style.footer}>
                <Row className="justify-content-center pt-5 mb-2">
                    ...
                    <a
                        href="https://www.reddit.com/r/MyriadeMining/"
                        target="_blank"
                        className={Style.link}
                    >
                    ...
                    <a
                        href="https://www.linkedin.com/company/myriade-inc"
                        target="_blank"
                        className={Style.link}
                    >
                ...
                <Row className="justify-content-center m-2">
                    <Link className={'m-1 ' + Style.link} to={ROUTES.PRIVACY}>
                        Privacy Policy
                    </Link>
                    <Link className={'m-1 ' + Style.link} to={ROUTES.COOKIES}>
                        Cookies Policy
                    </Link>
                    <Link className={'m-1 ' + Style.link} to={ROUTES.TERMS}>
                        Terms of Service
                    </Link>
                </Row>
