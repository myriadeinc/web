        ...
        {this.state.windowsVideo && (
          <Jumbotron className="p-2">
            <ResponsiveEmbed aspectRatio="16by9">
              <iframe
                src="https://www.youtube.com/embed/11i66_6rJSM"
                frameBorder="0"
                allowFullScreen
              ></iframe>
            </ResponsiveEmbed>
        ...
        <Row>
          <Col md={{ offset: 4, span: 4 }} style={{ textAlign: 'center' }}>
            <PrimaryButton
              pill
              style={{ margin: 10 }}
              href="https://github.com/xmrig/xmrig/releases/download/v6.12.1/xmrig-6.12.1-gcc-win64.zip"
            >
        ...
        <Row>
          <Col md={{ offset: 2, span: 4 }} style={{ textAlign: 'center' }}>
            <PrimaryButton
              pill
              style={{ margin: 10 }}
              href="https://github.com/xmrig/xmrig/releases/download/v6.12.1/xmrig-6.12.1-linux-x64.tar.gz"
            >
          ...
          <Col md={{ offset: 0, span: 4 }} style={{ textAlign: 'center' }}>
            <PrimaryButton
              pill
              style={{ margin: 10 }}
              href="https://github.com/xmrig/xmrig/releases/download/v6.12.1/xmrig-6.12.1-macos-x64.tar.gz"
            >
