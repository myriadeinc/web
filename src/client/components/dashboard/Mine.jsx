    ...
    return (
      <Container>
        ...
        <p>
          ...
          . Once on that page select xmrig-5.5.0-gcc-win64.zip for 64-bit and
          xmrig-5.5.0-gcc-win32.zip for 32-bit, or alternatively, select any
          other release and versions.
        </p>
  ...
  render() {
    return (
      <Container className={Style.Container}>
        ...
        <Alert theme="warning">
          {" "}
          <strong>Important! </strong> Our pool is currently not open to the
          public. Learn more about our beta program and Testnet mining program
          by shooting us an email at info@myriade.io
        </Alert>
