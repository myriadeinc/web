(function(){
  ...
  <body>
    <div id="poolAlert" class="alert alert-warning alert-dismissible fade show mb-0" role="alert">
      Our Mining Pool is in alpha so there may be some issues. Currently we are facing downtime and are working on a fix.
      Withdrawals and Game room are still operational. Check back with us soon. Thanks for your patience!
    ...
    <div class="row col-9 d-flex justify-content-center mx-auto">
      <div class="hero-img">
        <img src="./assets/img/app.png" class="img-fluid mx-auto justify-content-center d-flex img-responsive" alt="App Image">
      </div>  
    </div>
    <main id="main">
            ...
            <div class="col-lg-6 mt-4">
              <div class="member d-flex align-items-start" data-aos="zoom-in" data-aos-delay="300">
                ...
                <div class="member-info">
                  ...
                  <p>"As someone who isn't great with computers, the desktop app is perfect, I can also mine for gift cards which is great for me to get my friends to start mining too. Myriade seems like it's made for beginners."</p>
                </div>
              </div>
            </div>
            <div class="col-lg-6 mt-4">
