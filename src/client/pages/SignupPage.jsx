...
class SignupPage extends Component {
  ...
  createAccount(e) {
    ...
    return axios
      .post(`${config.identity_service_url}/v1/account/create/`, {
        email_token,
        name,
        password,
      ...
      .catch((err) => {
        return this.setState({
          error:
            "Failed to create an account, please check your inputs and try again",
        });
      });
  }
  ...
  displaySuccess() {
    return (
      <Alert theme="success" dismissible={this.dismissError}>
        Great! A confirmation e-mail has been sent to you, make sure to check
        your inbox including spam folder to find it. Follow the link inside that
        e-mail to continue with your account creation!
      </Alert>
    );
  }
    ...
    if (this.state.complete) {
      ...
      return (
        <Container>
          ...
          <Row
            className={
              PageStyle.LoginPageBackground + " justify-content-center"
            }
          >
            <Card className={PageStyle.EmailCard}>
              {!this.state.next_step ? (
                <Card>
                      ...
                      <FormGroup>
                        <>
                          ...
                          <PrimaryButton
                            pill
                            type="submit"
                            disabled={this.state.email_confirmed}
                          >
                            Confirm
                          </PrimaryButton>
                        </>
                  ...
                  <CardFooter>
                    Already have a Myriade account? Log in{" "}
                ...
                <CardBody>
                  ...
                  <p>
                    Thanks for confirming your email address, now you can create
                    your Myriade account!
                  </p>
                  <Form onSubmit={this.createAccount}>
                    ...
                    <FormGroup>
                      <Row className="m-0">
                        ...
                        <Badge
                          className={PageStyle.badge}
                          target="_blank"
                          href="https://medium.com/@paul_70212/how-to-get-yourself-a-monero-xmr-wallet-address-2edb75a0a575"
                          pill
                          outline
                          theme="info"
                        >
