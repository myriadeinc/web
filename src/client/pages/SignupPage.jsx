    ...
    displaySuccess() {
        return (
            <Alert theme="success" dismissible={this.dismissError}>
                Great! A confirmation e-mail has been sent to you, make sure to
                check your inbox including spam folder to find it. Follow the
                link inside that e-mail to continue with your account creation!
            </Alert>
        )
    }
                            ...
                            <Card className={PageStyle.EmailCard}>
                                {!this.state.next_step ? (
                                    <Card>
                                        ...
                                        <CardFooter>
                                            Already have a Myriade account? Log
                                            in{' '}
                                    ...
                                    <CardBody>
                                        ...
                                        <p>
                                            ...
                                            address, now you can create your
                                            Myriade account!
                                        </p>
